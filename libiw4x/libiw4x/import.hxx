// These type definitions are reverse-engineered.
//
// The structures and enumerations in this header were reconstructed from a mix
// of resources and manual static analysis, and should be treated as
// approximate rather than authoritative.
//
// Layout details may differ. If you rely on a specific field and hit a crash,
// the most likely cause is an incorrect offset. In that case, double check the
// layout in IDA.
