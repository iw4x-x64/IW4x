...
namespace iw4x
{
  ...
  ::iw4x::cli::usage_para options::
  print_usage (::std::ostream& os, ::iw4x::cli::usage_para p)
  {
  ...
  typedef
  std::map<std::string, void (*) (options&, ::iw4x::cli::scanner&)>
  _cli_options_map;
  ...
  struct _cli_options_map_init
  {
    _cli_options_map_init ()
    {
      ...
      &::iw4x::cli::thunk< options, std::uint64_t, &options::build2_metadata_,
  ...
  bool options::
  _parse (const char* o, ::iw4x::cli::scanner& s)
  {
  ...
  bool options::
  _parse (::iw4x::cli::scanner& s,
          ::iw4x::cli::unknown_mode opt_mode,
          ::iw4x::cli::unknown_mode arg_mode)
  {
    // Can't skip combined flags (--no-combined-flags).
    //
    assert (opt_mode != ::iw4x::cli::unknown_mode::skip);
    ...
    while (s.more ())
    {
      ...
      if (opt)
      {
        ...
        if (std::strncmp (o, "-", 1) == 0 && o[1] != '\0')
        {
          ...
          if (const char* v = std::strchr (o, '='))
          {
            ...
            ::iw4x::cli::argv_scanner ns (0, ac, av);
            ...
            if (_parse (co.c_str (), ns))
            {
              ...
              //
              if (ns.end () != 2)
                throw ::iw4x::cli::invalid_value (co, v);
          ...
          switch (opt_mode)
          {
            case ::iw4x::cli::unknown_mode::skip:
            {
              s.skip ();
              r = true;
              continue;
            }
            case ::iw4x::cli::unknown_mode::stop:
            {
              break;
            }
            case ::iw4x::cli::unknown_mode::fail:
            {
              throw ::iw4x::cli::unknown_option (o);
            }
          }
      ...
      switch (arg_mode)
      {
        ...
        case ::iw4x::cli::unknown_mode::fail:
        {
          throw ::iw4x::cli::unknown_argument (o);
        }
      }
